document.addEventListener('DOMContentLoaded', async () => {
    ...
    function getBirdCategory(bird) {
        ...
        // Handle specific known "incorrect" names from your JSON
        ...
        // If not a common category, try to use a general term or a fallback
    ...
    function displayBirds(birdsToDisplay) {
        ...
        birdsToDisplay.forEach(bird => {
            ...
            card.addEventListener('click', () => {
                window.location.href = `bird_info.html?name=${encodeURIComponent(bird.name)}`;
            });
            card.addEventListener('keydown', (event) => { // Accessibility for keyboard navigation
